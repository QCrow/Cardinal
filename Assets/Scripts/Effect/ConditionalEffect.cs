...
// {
//     public CardInstance Card; // Card that the effect is attached to
//     protected List<Effect> _effects;

//     public ConditionalEffect(CardInstance card, List<Effect> effects)
//     {
//         Card = card;
//         _effects = effects;
//     }
...
// {
//     public ConstantEffect(CardInstance card, List<Effect> effects) : base(card, effects) { }
...
//     public PositionCondition(CardInstance card, List<Effect> effects, PositionType position) : base(card, effects)
//     {
//         Position = position;
//     }
...
//     public TargetWithFilterCondition(CardInstance card, List<Effect> effects, Target targetField, CheckType check, int minimum) : base(card, effects)
//     {
...
//     public override void ApplyEffect()
//     {
//         List<CardInstance> targets = TargetField.GetAvailableCardTargets(Card);
//         switch (_check)
//         {
...
//     public CycleCondition(CardInstance card, List<Effect> effects, int cycleCount) : base(card, effects)
//     {
